...
?>
<?$APPLICATION->IncludeComponent("bitrix:news", "hasta_news", Array(
	"ADD_ELEMENT_CHAIN" => "Y",	// Включать название элемента в цепочку навигации
		...
		"PAGER_TITLE" => "Заметки",	// Название категорий
		...
		"SEF_FOLDER" => "/hasta/notes/",	// Каталог ЧПУ (относительно корня сайта)
