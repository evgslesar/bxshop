...
<div class="sh-comments-section">
	<div class="sh-comments-heading">
	<h2>Комментарии</h2>
	</div>
...
<ul class="sh-comments-list list-unstyled" id="<?=$arParams["FORM_ID"]?>container">
<?
$iCount = 0;
foreach ($arResult["MESSAGES"] as $res):
	...
	<li class="<?=($iCount == 1 ? "first-comment " : "")?>
		...
		<div class="txt" style="position: relative;">
			...
			<time class="sh-time" datetime="<?=$res["POST_DATE"]?>"><?=$res["POST_DATE"]?></time>
