...
<div class="product-collection d-flex flex-column mb-30">
	<div class="product-collection__image product-image product-image--hover-fade position-relative w-100">
		
		<a class="d-block" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>" data-entity="image-wrapper">
			<div class="rimage slide"  id="<?=$itemIds['PICT_SLIDER']?>"
				<?=($showSlider ? 'style="padding-top:128.0%;"' : 'style="display: none;"')?>
				...
				if ($showSlider)
				{
					foreach ($morePhoto as $key => $photo)
					{
						?>
						<img src="<?=$photo['SRC']?>"
							class="rimage__img item <?=($key == 0 ? ' active' : '')?>"
							alt="<?=$photo['ALT']?>">
					<?
					}
				}
			...
			<div class="rimage" style="<?=($showSlider ? 'display: none;' : 'padding-top:128.0%;')?>">
				<img src="<?=$item['PREVIEW_PICTURE']['SRC']?>" id="<?=$itemIds['PICT']?>"
					class="rimage__img prim" style="opacity: 1;"
		...
		<!-- <div class="product-image__overlay-bottom position-absolute d-flex justify-content-center justify-content-lg-start align-items-end bottom-0 left-0 w-100 px-10 pb-10">
			<div class="product-image__overlay-bottom-right product-collection__images-navigation position-relative d-lg-block mt-10 ml-auto">
				<div class="product-images-navigation d-flex">
					...
					<span class="d-flex flex-center rounded-circle cursor-pointer" data-entity="slider-control-right">
						<i class="ml-3">
							<svg aria-hidden="true"
										focusable="false"
										role="presentation"
										...
										foreach ($arParams['SKU_PROPS'] as $skuProperty)
										{
											...
											<div data-entity="sku-block">
												<div data-entity="sku-line-block">
													...
													<ul class="product-options__section d-flex flex-wrap list-unstyled">
														...
														foreach ($skuProperty['VALUES'] as $value)
														{
															...
															if ($skuProperty['SHOW_MODE'] === 'PICT')
															{
																...
																<li class="product-options__value product-options__value--square" title="<?=$value['NAME']?>"
																		data-treevalue="<?=$propertyId?>_<?=$value['ID']?>" data-onevalue="<?=$value['ID']?>"
																		style="background-image: url('<?= $imgPath ?>');background-size:contain;">
																</li>
																<?
															}
															else
															{
																?>
																<li class="product-options__value product-options__value--large-text d-flex flex-center border cursor-pointer"
																	data-treevalue="<?=$propertyId?>_<?=$value['ID']?>" data-onevalue="<?=$value['ID']?>">
																	<?=$value['NAME']?>
																</li>
