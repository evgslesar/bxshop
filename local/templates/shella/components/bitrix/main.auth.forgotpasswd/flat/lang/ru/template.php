...
$MESS['MAIN_AUTH_PWD_NOTE'] = 'Если вы забыли пароль, введите свой E-Mail. Контрольная строка для смены пароля, а также ваши регистрационные данные, будут высланы на указанный адрес.';
$MESS['MAIN_AUTH_PWD_FIELD_LOGIN'] = 'Логин';
$MESS['MAIN_AUTH_PWD_OR'] = 'или';
$MESS['MAIN_AUTH_PWD_FIELD_EMAIL'] = 'Эл. почта';
