...
?>
<div id="theme-section-1537376166880" class="theme-section" data-entity="<?=$containerName?>">
	...
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		?>
		<!-- items-container -->
		<div class="sorting-collections__products row" data-entity="items-row" data-sorting-collections-items data-limit="8" data-grid="col-6 col-sm-6 col-md-4 col-lg-3">
		<?
