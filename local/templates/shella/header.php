...
<head>
    ...
    // CSS;
    Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . '/styles/start-style.css');
    // HEADERS
	...
	<script>
		var Loader = {
			...
			includes: {
				scripts: {
					//plugins
					plugin_popper: '<?= SITE_TEMPLATE_PATH ?>/scripts/plugin.popper.min.js',
					plugin_tippy: '<?= SITE_TEMPLATE_PATH ?>/scripts/plugin.tippy.all.min.js',
					plugin_fotorama: '<?= SITE_TEMPLATE_PATH ?>/scripts/plugin.fotorama.min.js',
					plugin_instafeed: '<?= SITE_TEMPLATE_PATH ?>/scripts/plugin.instafeed.min.js',
					plugin_ion_range_slider: '<?= SITE_TEMPLATE_PATH ?>/scripts/plugin.ion-range-slider.min.js',
					plugin_masonry: '<?= SITE_TEMPLATE_PATH ?>/scripts/plugin.masonry.min.js',
					plugin_revolution_slider: '<?= SITE_TEMPLATE_PATH ?>/scripts/plugin.revolution-slider.min.js',
					plugin_sticky_sidebar: '<?= SITE_TEMPLATE_PATH ?>/scripts/plugin.sticky-sidebar.min.js',
					//global
					vendor: '<?= SITE_TEMPLATE_PATH ?>/scripts/vendor.min.js',
					theme: '<?= SITE_TEMPLATE_PATH ?>/scripts/theme.min.js',
					//modules
					tooltip: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.tooltip.min.js',
					buttons_blocks_visibility: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.buttons-blocks-visibility.min.js',
					collections: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.collections.min.js',
					dynamic_checkout: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.dynamic-checkout.min.js',
					masonry: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.masonry.min.js',
					// notifications: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.notifications.min.js',
					parallax: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.parallax.min.js',
					popup_subscription: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.popup-subscription.min.js',
					product_footbar: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.product-footbar.min.js',
					products_view: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.products-view.min.js',
					range_of_price: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.range-of-price.min.js',
					shipping_rates_calculation: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.shipping-rates-calculation.min.js',
					sticky_header: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.sticky-header.min.js',
					sticky_sidebar: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.sticky-sidebar.min.js',
					tabs: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.tabs.min.js',
					trigger: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.trigger.min.js',
					presentation: '<?= SITE_TEMPLATE_PATH ?>/scripts/module.presentation.min.js',
					//sections
					header: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.header.min.js',
					article_body: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.article-body.min.js',
					blog_body: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.blog-body.min.js',
					blog_sidebar: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.blog-sidebar.min.js',
					carousel_articles: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.carousel-articles.min.js',
					carousel_brands: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.carousel-brands.min.js',
					carousel_products: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.carousel-products.min.js',
					collection_body: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.collection-body.min.js',
					collection_head: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.collection-head.min.js',
					collection_sidebar: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.collection-sidebar.min.js',
					gallery: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.gallery.min.js',
					home_builder: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.home-builder.min.js',
					list_collections: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.list-collections.min.js',
					lookbook: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.lookbook.min.js',
					password_page_content: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.password-page-content.min.js',
					product: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.product.min.js',
					slider_revolution: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.slider-revolution.min.js',
					sorting_collections: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.sorting-collections.min.js',
					footbar: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.footbar.min.js',
					footer: '<?= SITE_TEMPLATE_PATH ?>/scripts/section.footer.min.js'
				},
				styles: {
					//plugins
					plugin_tippy: '<?= SITE_TEMPLATE_PATH ?>/styles/plugin.tippy.min.css',
					plugin_fotorama: '<?= SITE_TEMPLATE_PATH ?>/styles/plugin.fotorama.min.css',
					plugin_ion_range_slider: '<?= SITE_TEMPLATE_PATH ?>/styles/plugin.ion-range-slider.min.css',
					plugin_revolution: '<?= SITE_TEMPLATE_PATH ?>/styles/plugin.revolution.min.css',
					plugin_slick: '<?= SITE_TEMPLATE_PATH ?>/styles/plugin.slick.min.css',
					//font
					text_font: 'https://fonts.googleapis.com/css?family=Archivo',
					//global
					theme: '<?= SITE_TEMPLATE_PATH ?>/styles/theme.min.css',
					...
					theme_14: '<?= SITE_TEMPLATE_PATH ?>/styles/theme-14.min.css',
...
<body id="index-14" class="template-index theme-css-animate" data-currency-multiple="true" data-style-file="theme_14">
					...
					<div class="header__line-top position-relative d-flex px-10 px-lg-0 py-lg-2">
						<div class="container d-flex align-items-center">
							<span class="header__btn-menu d-flex align-items-center d-lg-none mr-20 cursor-pointer js-popup-button" data-js-popup-button="navigation">
								<i><svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-theme-191" viewBox="0 0 24 24">
							...
							<div class="header__logo header__logo--sticky-hidden d-flex align-items-center w-100" style="max-width: 64px;">
								<h1 class="logo h6 w-100 m-0 text-hide" itemscope itemtype="http://schema.org/Organization" data-js-sticky-replace-element="logo">
									<a href="/hasta/" itemprop="url" class="d-block text-hide">
							...
							<div class="header__sidebar d-flex align-items-center ml-auto">
								<a href="#" class="header__btn-services position-relative d-flex align-items-center ml-25 ml-lg-15 js-popup-button" data-js-popup-button="services" data-js-tooltip data-tippy-content="Client service" data-tippy-placement="bottom" data-tippy-distance="6">
									<i>
								...
								<a href="/hasta/personal" class="header__btn-account d-flex align-items-center position-relative ml-25 ml-lg-15 js-popup-button" data-js-tooltip data-tippy-content="Account" data-tippy-placement="bottom" data-tippy-distance="6">
									<i>
								...
								<div class="ml-25 ml-lg-15">
									<a href="#" class="header__btn-wishlist d-flex align-items-center position-relative text-nowrap js-popup-button" data-js-popup-button="wishlist" data-js-sticky-replace-element="wishlist" data-js-tooltip data-tippy-content="Wish list" data-tippy-placement="bottom" data-tippy-distance="6">
										<i>
								...
								<div class="ml-25 ml-lg-15">
								<div id="compare_list_count_sh"  class="col-xs-6 col-md-3 col-lg-2 text-right">
									<?php $APPLICATION->IncludeComponent(
										...
										array(
											...
											"COMPARE_URL" => "/hasta/goods/compare.php",
											"NAME" => "CATALOG_COMPARE_LIST",
											"AJAX_OPTION_ADDITIONAL" => "",
											"COMPONENT_TEMPLATE" => "sh_compare_top",
											"POSITION_FIXED" => "Y",
											"POSITION" => "top left",
	...
	false
									...
									<div class="js-position js-dropdown js-currencies-list" data-js-position-name="currencies">
										...
										<div class="header__dropdown dropdown d-lg-none position-lg-absolute top-lg-100 right-lg-0" data-js-dropdown>
											<ul class="list-unstyled w-100 px-15 py-30 py-lg-15">
												<li class="active" data-button-name="US($)" data-currency-code="USD"><a href="#USD">USD - US Dollar</a></li>
								...
								<div class="position-lg-relative d-none d-lg-block ml-lg-15" data-js-position-desktop="languages">
									<div class="js-position js-dropdown js-languages-list" data-js-position-name="languages">
										<div class="header__btn-language position-relative d-none d-lg-flex align-items-lg-center cursor-pointer" data-js-dropdown-button=""><span class="mt-lg-3">English</span> <i>
												<svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-theme-229" viewBox="0 0 24 24">
